...
class Lotto extends Model
{
    ...
    {
        return $this->belongsToMany(ResultDate::class, 'lotto_three_digit_pivot', 'lotto_id', 'result_date_id')->withPivot('bet_digit', 'sub_amount', 'prize_sent', 'res_date', 'match_start_date', 'user_log', 'created_at');
    }
